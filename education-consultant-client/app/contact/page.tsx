  ...
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div>
            ...
            <p className="mt-3 text-base-content ">We’d love to hear from you. Please fill out this form or shoot us an email.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p className="mt-2 text-sm text-base-content ">Our friendly team is here to help.</p>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-base-content ">Come say hello at our office HQ.</p>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-base-content ">Mon-Fri from 8am to 5pm.</p>
