import { applyForm, fff } from "@/actions/applyForm";
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center">
        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl">
          Apply <mark className="px-2 text-white bg-primary rounded-lg">Now</mark> Online
        </h1>
      ...
      <div className="w-full flex justify-center lg:justify-start my-10">
        <Image className="object-cover object-center rounded-lg" src={aboutBanner} alt="about banner" />
      </div>
            ...
            <form action={fff} className="card-body">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div className="form-control">
                  ...
                  <input type="tel" name="tel" placeholder="+880" className="input input-bordered" required />
                </div>
                <div className="form-control">
                  <label className="label">
                ...
                <div className="form-control">
                  ...
                  <select className="select select-bordered" name="englishTest">
                ...
                <div className="form-control">
                  ...
                  <textarea name="academicDetails" placeholder="Enter previous institute, subject, group, passing year, or result" className="textarea textarea-bordered" required></textarea>
                </div>
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">Study Destination</span>
                  </label>
                  <select className="select select-bordered" name="studyDestination">
